...
exports.getJsCodeshiftParser = void 0;
// @ts-nocheck
const node_fs_1 = require("node:fs");
const node_path_1 = require("node:path");
const core_1 = require("@babel/core");
const argsParser_1 = __importDefault(require("jscodeshift/dist/argsParser"));
...
const defaultExtensions = core_1.DEFAULT_EXTENSIONS.concat(["ts", "tsx"])
    .map((ext) => (ext.startsWith(".") ? ext.substring(1) : ext))
    .sort()
    .join(",");
const getJsCodeshiftParser = () => argsParser_1.default.options({
    transform: {
        display_index: 15,
        abbr: "t",
