...
exports.getTypeForString = void 0;
const arrayRegex = /^Array<(.*)>$/;
const recordRegex = /^Record<string, (.*)>$/;
const getTypeForString = (j, v2ClientLocalName, v3ClientTypeString) => {
    ...
    if (arrayRegexMatches) {
        ...
        const typeArgument = (0, exports.getTypeForString)(j, v2ClientLocalName, type);
...
exports.getTypeForString = getTypeForString;
